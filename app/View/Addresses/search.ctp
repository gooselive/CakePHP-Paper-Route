...
<div class="addresses index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('plus4'); ?></th>
...
<div class="actions">
	<?php echo $this->element('searchForm/addressform') //search form element?>
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Subscribers'), array('controller' => 'subscribers', 'action' => 'search')); ?> </li>
