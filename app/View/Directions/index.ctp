<div class="directions index">
	...
	<tr>
		...
		<td><?php echo h($direction['Direction']['street_name']); ?>&nbsp;</td>
		<td><?php echo h($direction['Direction']['created']); ?>&nbsp;</td>
		<td><?php echo h($direction['Direction']['modified']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('List Route Items'), array('controller' => 'routeItems', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Route Item'), array('controller' => 'routeItems', 'action' => 'add')); ?> </li>
	</ul>
</div>
