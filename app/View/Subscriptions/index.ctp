<div class="subscriptions index">
	...
	<tr>
		<td>
		<?php echo ucwords(strtolower($this->Html->link($subscription['Address']['address'], array('controller' => 'addresses', 'action' => 'view', $subscription['Address']['id'])))); ?>
		</td>
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Search Subscriptions'), array('action' => 'search')); ?></li>
